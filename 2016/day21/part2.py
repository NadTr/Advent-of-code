...
scrambled = "fbgdceah"
start_string = "fbgdceah"
starters = itertools.permutations(start_string)
unscrambled_letters = ""

def scramble(letters):

    def swap(a,b):
        nonlocal letters_order
...
for starter in starters:
    scrambled_letters = scramble(starter)
    # print(starter, scrambled_letters)
    if  "".join(x for x in scrambled_letters) == scrambled:
        unscrambled_letters = starter
        print(unscrambled_letters)
        break
        
unscrambled = "".join(x for x in unscrambled_letters)

print("The the result of scrambling ", scrambled," is", unscrambled)